      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto magic-backdrop rounded-3xl p-8 md:p-12 animate-fade-in">
          ...
          <p className="text-lg md:text-xl magic-text mb-12 text-center max-w-4xl mx-auto leading-relaxed">
            Уникальная авторская методика, которая помогает астрологам и родителям глубже понять 
            особенности ребёнка, выявить причины трудностей и подобрать индивидуальные решения 
            для гармонизации.
          </p>
          ...
          <div className="text-center mb-8">
            ...
            <img
              src="/lovable-uploads/0260dfbc-130b-4263-a72b-5624ef31d392.png"
              alt="Планеты и астрология"
              className="max-w-full h-auto rounded-2xl mx-auto floating-element"
              style={{
                maxHeight: '400px',
