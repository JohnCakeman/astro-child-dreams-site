  ...
  return <section id="about-guide" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto magic-backdrop rounded-3xl p-8 md:p-12 animate-fade-in">
          ...
          <p className="text-lg md:text-xl magic-text mb-12 text-center max-w-4xl mx-auto leading-relaxed">Уникальная авторская методика, которая помогает астрологам и родителям глубже понять особенности ребёнка, выявить причины трудностей и подобрать индивидуальные решения для гармонизации. (нажми на планету)</p>
          
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 mb-12">
            {planets.map(planet => <div key={planet.name} className="text-center group cursor-pointer" onClick={() => onPlanetClick(planet.name)}>
                <img src={planet.image} alt={planet.title} className="planet-icon mx-auto mb-3" />
          ...
          <div className="text-center mb-8">
            ...
            <img src="/lovable-uploads/0260dfbc-130b-4263-a72b-5624ef31d392.png" alt="Планеты и астрология" className="max-w-full h-auto rounded-2xl mx-auto floating-element" style={{
            maxHeight: '400px',
