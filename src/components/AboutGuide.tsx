...
const AboutGuide = ({ onPlanetClick }: AboutGuideProps) => {
  ...
  const handlePlanetInteraction = (planetName: string) => {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto magic-backdrop rounded-3xl p-8 md:p-12 animate-fade-in bg-[#cfc5dd]/85">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 mb-12">
            {planets.map((planet) => (
              <div
                ...
                onClick={isMobile ? () => handlePlanetInteraction(planet.name) : undefined}
                onMouseEnter={!isMobile ? () => handlePlanetInteraction(planet.name) : undefined}
              >
                <img
                  src={planet.image}
                  alt={planet.title}
          ...
          <div className="text-center mb-8">
            ...
            {/* Planets Video */}
            <div
              className="max-w-full mx-auto rounded-2xl overflow-hidden"
              style={{
                maxHeight: '400px',
