    ...
    <section id="contacts" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto magic-backdrop rounded-3xl p-8 md:p-12 animate-fade-in text-center">
          ...
          <p className="text-lg magic-text mb-8 leading-relaxed">
            Пишите в Telegram! Отвечу на все ваши вопросы о пособии и методике.
          </p>
          
          <div className="space-y-6">
            <a
              href="https://t.me/+7UrXiA62gZ45NDky"
              className="magic-button inline-flex items-center space-x-3"
            >
